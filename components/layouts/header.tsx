                    ...
                    <li className="menu nav-item relative">
                        <button type="button" className="nav-link">
                            <div className="flex items-center">
                                ...
                                <span className="px-1">Transactions</span>
                            </div>
                        ...
                        <ul className="sub-menu">
                            <li>
                                <Link href="/patient-registration">Patient Registration</Link>
                            </li>
                            <li>
                                <Link href="/patient-management">Patient Management</Link>
                            </li>
                            <li>
                                <Link href="/transactions-management">Transactions Management</Link>
                            </li>
                            ...
                            <li>
                                <Link href="/released-results">Released Result</Link>
                            </li>
                        </ul>
                    </li>
                    <li className="menu nav-item relative">
                        <button type="button" className="nav-link">
                            <div className="flex items-center">
                                ...
                                <span className="px-1">Masterfile</span>
                            </div>
                            <div className="right_arrow">
                                <IconCaretDown />
                            </div>
                        ...
                        <ul className="sub-menu">
                            <li>
                                <Link href="/masterfile/test">Test</Link>
                            </li>
                            <li>
                                <Link href="/masterfile/package">Package</Link>
                            </li>
                            <li>
                    ...
                    <li className="menu nav-item relative">
                        <button type="button" className="nav-link">
                            <div className="flex items-center">
                                ...
                                <span className="px-1">Administrative</span>
                            </div>
                            <div className="right_arrow">
                                <IconCaretDown />
                            </div>
                        ...
                        <ul className="sub-menu">
                            <li>
                                <Link href="/">User Managemen</Link>
                            </li>
                            <li>
                                <Link href="/">Signatory</Link>
                            </li>
                            <li>
                                <Link href="/administrative/discount">Discount</Link>
                            </li>
                        </ul>
                    </li>
                    {/* <li className="menu nav-item relative">

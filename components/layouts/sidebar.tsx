                ...
                <div className="h-full bg-white dark:bg-black">
                    <div className="flex items-center justify-between px-4 py-3">
                        <Link href="/" className="main-logo flex shrink-0 items-center">
                            {/* <img className="ml-[5px] w-8 flex-none" src="/assets/images/auth/theralogo.png" alt="logo" /> */}
                            <span className="text-xs dark:text-white-light lg:inline font-xspace">
                                <span className="bg-gradient-to-tr from-green-500 to-indigo-600 bg-clip-text text-transparent">THERA</span>DIAGNOSTICS
                            </span>
                        </Link>
                    ...
                    <PerfectScrollbar className="relative h-[calc(100vh-80px)]">
                        <ul className="relative space-y-0.5 p-4 py-0 font-semibold">
                            ...
                            <li className="nav-item">
                                <ul>
                                    <li className="nav-item">
                                        <Link href="/patient-registration" className="group">
                                            <div className="flex items-center">
                                                <IconUserPlus className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Patient Registration</span>
                                            </div>
                                        </Link>
                                    </li>
                                    <li className="nav-item">
                                        <Link href="/patient-management" className="group">
                                            <div className="flex items-center">
                                                <IconUsersGroup className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Patient Management</span>
                                            </div>
                                        </Link>
                                    </li>

                                    <li className="nav-item">
                                        <Link href="/transactions-management" className="group">
                                            <div className="flex items-center">
                                                <IconShoppingCart className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Transactions Management</span>
                                            </div>
                                        </Link>
                                    </li>

                                    <li className="menu nav-item">
                                        <button type="button" className={`${currentMenu === 'component' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('results_management')}>
                                            <div className="flex items-center">
                                                <IconNotes className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Results Management</span>
                                            </div>

                                            <div className={currentMenu !== 'results_management' ? '-rotate-90 rtl:rotate-90' : ''}>
                                                <IconCaretDown />
                                            </div>
                                        </button>

                                        <AnimateHeight duration={300} height={currentMenu === 'results_management' ? 'auto' : 0}>
                                            <ul className="sub-menu text-gray-500">
                                                <li>
                                                    <Link href="/results-management/result-entry">Result Entry</Link>
                                                </li>
                                                <li>
                                                    <Link href="/results-management/result-evaluation">Result Evaluation</Link>
                                                </li>
                                            </ul>
                                        </AnimateHeight>
                                    </li>
                                    ...
                                    <li className="nav-item">
                                        <Link href="/released-results" className="group">
                                            <div className="flex items-center">
                                                <IconListCheck className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Released Results</span>
                                            </div>
                                        </Link>
                                    </li>
                                    {/* <li className="nav-item">
                            ...
                            <li className="menu nav-item">
                                <ul>
                                    <li className="menu nav-item">
                                        <Link href="/masterfile/test" className="group">
                                            <div className="flex items-center">
                                                <IconFolderPlus className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Test</span>
                                            </div>
                                        </Link>
                                    </li>

                                    <li className="menu nav-item">
                                        <Link href="/masterfile/package" className="group">
                                            <div className="flex items-center">
                                                <IconFolderPlus className="shrink-0 group-hover:!text-primary" />
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Package</span>
                                            </div>
                                        </Link>
                                    </li>
                                    ...
                                    <li className="menu nav-item">
                                        <Link href="/masterfile/package" className="group">
                                            <div className="flex items-center">
                                                ...
                                                <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Company Management</span>
                                            </div>
                                        </Link>
                                    </li>
                                </ul>
                            ...
                            <li className="menu nav-item">
                                <Link href="/masterfile/package" className="group">
                                    <div className="flex items-center">
                                        <IconMenuUsers className="shrink-0 group-hover:!text-primary" />
                                        <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Signatory</span>
                                    </div>
                                </Link>
                            </li>

                            <li className="menu nav-item">
                                <Link href="/administrative/discount" className="group">
                                    <div className="flex items-center">
                                        <IconDollarSignCircle className="shrink-0 group-hover:!text-primary" />
                                        <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">Discount</span>
                                    </div>
                                </Link>
                            </li>
